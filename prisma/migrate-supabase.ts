...
async function main() {
  ...
  // Mathematics & Statistics (15 courses)
  const mathCourses = [
    ["MATH101","高等数学（上）",5,"极限、导数与一元函数微积分",2],
    ["MATH102","高等数学（下）",5,"多元微积分、无穷级数与常微分方程",2],
    ["MATH103","线性代数",3,"矩阵理论、向量空间与线性变换",2],
    ["MATH104","概率论与数理统计",4,"随机变量、抽样分布与假设检验",2],
    ["MATH105","离散数学",3,"集合论、图论与数理逻辑基础",2],
    ["MATH106","数值分析",3,"数值逼近、数值积分与微分方程数值解",2],
    ["MATH107","数学建模",3,"优化算法、微分方程建模与MATLAB应用",2],
    ["MATH108","复变函数",3,"复积分、留数定理与共形映射",2],
    ["MATH109","常微分方程",3,"初值问题、稳定性理论与动力系统",2],
    ["MATH110","运筹学",3,"线性规划、网络优化与博弈论",2],
    ["MATH111","抽象代数",3,"群论、环论与域论基础",2],
    ["MATH112","实变函数",3,"测度论、勒贝格积分与泛函分析入门",2],
    ["MATH113","拓扑学",3,"点集拓扑、连续性理论与基本群",2],
    ["MATH114","时间序列分析",3,"ARIMA模型、GARCH与金融预测",2],
    ["MATH115","多元统计分析",3,"主成分分析、因子分析与聚类方法",2],
  ];

  // Foreign Languages (8 courses)
  const engCourses = [
    ["ENG101","大学英语I",2,"综合英语听、说、读、写基础训练",4],
    ["ENG102","大学英语II",2,"学术英语阅读与四级考试专项训练",4],
    ["ENG103","大学英语III",2,"学术英语写作与六级考试备考",4],
    ["ENG104","大学英语IV",2,"高级英语口语表达与辩论技巧",4],
    ["ENG105","商务英语",2,"商务信函写作、谈判技巧与跨文化交际",4],
    ["ENG106","英美文学选读",3,"英美经典小说、诗歌与文学批评入门",4],
    ["ENG107","翻译理论与实践",2,"英汉互译技巧与CAT工具应用",4],
    ["ENG108","英语演讲与辩论",2,"演讲策略、辩论技巧与即兴表达训练",4],
  ];

  // Business & Economics (10 courses)
  const busCourses = [
    ["BUS201","管理学原理",3,"管理理论、组织行为与战略决策",5],
    ["BUS202","微观经济学",3,"供需理论、市场结构与消费者行为",5],
    ["BUS203","宏观经济学",3,"国民收入、货币政策与经济周期",5],
    ["BUS204","会计学基础",3,"财务报表分析、借贷记账与成本核算",5],
    ["BUS205","市场营销学",3,"市场定位、品牌管理与数字营销策略",5],
    ["BUS206","人力资源管理",2,"招聘甄选、绩效管理与薪酬设计",5],
    ["BUS207","财务管理",3,"资本预算、融资决策与股利政策",5],
    ["BUS208","电子商务",3,"电商模式、电子支付与网络营销实务",5],
    ["BUS209","供应链管理",2,"采购优化、库存控制与物流规划",5],
    ["BUS210","创业管理",2,"商业计划书撰写、融资策略与创新管理",5],
  ];

  // Electronic Engineering (8 courses)
  const eeCourses = [
    ["EE301","电路分析基础",3,"电路定律、交流电路与暂态分析",6],
    ["EE302","数字电路与逻辑设计",3,"组合逻辑、时序电路与VHDL设计",6],
    ["EE303","通信原理",4,"模拟调制、数字调制与信道编码理论",6],
    ["EE304","信号与系统",3,"连续与离散信号、傅里叶变换与系统分析",6],
    ["EE305","电磁场与电磁波",3,"矢量分析、麦克斯韦方程与天线原理",6],
    ["EE306","嵌入式系统设计",3,"ARM Cortex架构、RTOS与设备驱动开发",6],
    ["EE307","数字信号处理",3,"DFT/FFT算法、FIR/IIR滤波器设计",6],
    ["EE308","光纤通信",2,"光纤传输原理、光器件与WDM系统",6],
  ];

  // Humanities (2 courses)
  const humCourses = [
    ["HUM101","中国近现代史纲要",2,"近代中国历史变迁与社会转型",7],
    ["HUM102","马克思主义基本原理",3,"辩证唯物主义与历史唯物主义",7],
  ];

  const allCourseDefs = [...csCourses, ...mathCourses, ...engCourses, ...busCourses, ...eeCourses, ...humCourses];
